...
**4 états de santé :** - *S* : Sain - *L* : Latent - *I* : Infectieux - *R* : Remis
...
-   période de latence entre état latent et infectieux (incubation)
-   période d'immunité
...
-   Journée avec le maximum d'infectieux sur la période de temps étudiée
  ...
  for (i in 1:nrow(parametre)) { 
    ...
    for (t in 1:(temps-1)) { 
     # Classe d'age Nouveau-né
      # RQ : les naissances sont uniquement dans la classe des sains, les nouveaux nes etant dans l'etat sain a la naissance
...
# Plot des résultats Nombre d'infectieux et l'incidence à l'année
